...
final class ParaphraseView: UIView {
    ...
    func processText(_ text: String?) async {
        guard let text = text, !text.isEmpty else {
            resultTitleLabel.isHidden = true
            resultTextView.text = "Select text or place your cursor at the end of a passage to paraphrase it."
            return
        }
...
//        if text == processedText { return }
        ...
        let result = await APIService.shared.paraphrase(text: text)
